...
const ComingSoon = ({ showKembali = true }: { showKembali?: boolean }) => {
  ...
  return (
    <div className="flex flex-col gap-4 items-center">
      <h1 className="font-bold text-2xl">Mohon bersabar man teman</h1>
      ...
      {showKembali && (
        <button
          onClick={goBack}
          className="py-2 px-8 rounded-md shadow-md hover:shadow-lg hover:brightness-110 hover:scale-105 ease-in duration-100 bg-blue-500 text-white">
          Kembali
        </button>
      )}
    </div>
