  ...
  return (
    <>
      ...
      <section className="flex-grow flex flex-col md:flex-row items-center justify-center w-full overflow-x-clip relative h-fit font-poppins">
        ...
        <section className="h-full w-full flex flex-col items-start justify-start gap-2 px-0 md:px-4 self-stretch border-r-2 md:w-[210px]">
          <div className="block md:fixed top-0 left-0 px-4 md:h-[100svh] md:shadow-lg overflow-y-auto bg-white md:bg-[#101351]">
            <div className="w-fit h-[4.5rem] hidden md:flex items-center gap-2">
              ...
              <h1
                className={`font-extrabold text-4xl duration-100 ease-in tracking-wider text-[#101351] md:text-white `}
              >
                Syntax
              </h1>
            </div>
            <div className="h-fit w-auto pt-2 flex flex-col">
              <h1 className="text-sm text-left text[#101351] md:text-white">
                Syntax | STEI-K 23
              </h1>
              <h2 className="text-[#101351] md:text-white text-4xl py-1 font-bold">
                BPA &apos;23
              </h2>
            </div>
            <div className="w-full flex flex-col h-fit">
              <div className="w-full md:w-[200px] h-fit space-y-1 hidden md:block">
                <h2 className="text-sm font-light uppercase tracking-wider md:pt-4 text-white">
                  Petinggi
                </h2>
                {bpaListGeneral.map((bpa) => (
                  ...
                  >
                    ...
                    <p className="text-[16px] text-white hover:brightness-95 rounded-md w-full py-1">
                      {bpa.name}
                    </p>
                  </Link>
                ))}
              ...
              <div className="block md:hidden">
                <h2 className="pt-4 border-b border-[#101351] text-[#101351]">
                  Petinggi
                </h2>
              ...
              <div>
                <h2 className="pt-4 border-b border-[#101351] md:border-white text-[#101351] md:text-white">
                  External
                </h2>
                <div className="w-full md:w-[200px] h-fit flex flex-row flex-wrap justify-start items-start gap-2 pt-2">
        ...
        {/* Info BPA */}
        <section
          className="h-fit w-full md:w-0 flex-grow pt-10 sm:pt-0 px-4 md:px-20 bg-white"
          id="right"
        >
          {bpaListGeneral.map((bpa) => (
